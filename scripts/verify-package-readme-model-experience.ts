...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-mobile-adapt': { kind: 'none', reason: 'Browser-side presentation layer (narrow-screen adaptation); registers nothing model-facing.' },
  'packages/client/ui-access-gate': { kind: 'none', reason: 'Browser-side login-gate card UI; the host gate service owns all auth behavior.' },
  'packages/client/ui-aionui-panel': { kind: 'none', reason: 'Browser-side panel UI (file tree / preview / SCM); registers nothing model-facing.' },
  'packages/client/ui-defaults': { kind: 'none', reason: 'Browser-side settings card over a host settings namespace; registers nothing model-facing.' },
  'packages/client/ui-pet': { kind: 'none', reason: 'Browser-side desktop-pet presentation; registers nothing model-facing.' },
  'packages/client/ui-git-graph': { kind: 'none', reason: 'Browser-side git graph view; registers nothing model-facing.' },
  'packages/client/ui-skin-center': { kind: 'none', reason: 'Browser-side skin-center UI; registers nothing model-facing.' },
  'packages/client/ui-skin-maid-atelier': { kind: 'none', reason: 'Browser-side skin asset (CSS/theme tokens); registers nothing model-facing.' },
  'packages/host/access-gate': { kind: 'none', reason: 'Host login-gate auth service (password gate, cert modes); registers nothing model-facing.' },
  'packages/host/aionui-panel': { kind: 'none', reason: 'Host panel file/preview serving for a browser UI; registers nothing model-facing.' },
  'packages/host/git-graph': { kind: 'none', reason: 'Host git service feeding a browser graph; registers nothing model-facing.' },
  'packages/client/ui-task-board': { kind: 'indirect', reason: 'The host half injects a system-prompt section announcing the board; the board view itself renders no model text.' },
  'packages/settings/defaults': { kind: 'none', reason: 'Host settings-namespace provider consumed by host services at read time; registers nothing model-facing.' },

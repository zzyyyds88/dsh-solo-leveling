/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-host-git-graph`.
 ...
 * @module @deepseek-ai/dsh-host-git-graph/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-host-git-graph'

...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    keyDomain: 'open: any string the owner dispatches (no compile-time key set), already taken: access-gate, aionui-panel, dsh-defaults, mobile-adapt, skins',
    hookContext: '',
    slotInject: '',
    ...
    occupants: [
      ...
      'client-ui-mobile-adapt MobileAdaptCard key \'mobile-adapt\'',
      ...
      'client-ui-skin-center SkinCenter key \'skins\'',

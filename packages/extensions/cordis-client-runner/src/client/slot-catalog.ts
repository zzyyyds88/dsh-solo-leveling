...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-live-stats TpsLineDockEntry id \'live-stats\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-aionui-panel DragFileInlay id \'aionui-drag-file\'',
      'client-ui-conversation QueueDock id \'queue\'',
      'client-ui-conversation TodoDock id \'todo\'',
      'client-ui-git-graph BranchChip',
  ...
  },
  {
    ...
    source: 'packages/client/ui-git-graph/src/client/index.ts:66',
  },
  {
  ...
  },
  {
    ...
    keyDomain: 'open: any string the owner dispatches (no compile-time key set), already taken: access-gate, aionui-panel, dsh-defaults, mobile-remote',
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'settings.plugins.tab\' (client-ui-settings-plugins), so it exists while that entry is mounted',
    occupants: [
      'client-ui-access-gate AccessGateCard key \'access-gate\'',
      'client-ui-aionui-panel AionUiPanelSettingsCard key \'aionui-panel\'',
      'client-ui-defaults DefaultsCard key \'dsh-defaults\'',
      'client-ui-describe-image DescribeImageSettingsCard',
      'client-ui-live-stats LiveStatsSettingsCard',
      'client-ui-mobile-adapt MobileAdaptCard',
      'client-ui-mobile-remote MobileRemoteCard key \'mobile-remote\'',
      'client-ui-pet DeepSeekPetSettingsCard',
      'client-ui-pet LedgerSettingsCard',
      'client-ui-settings-plugins BashCard',
      'client-ui-settings-plugins AgentLoopCard',
      'client-ui-settings-plugins WebSearchCard',
      'client-ui-skin-center SkinCenter',
      'client-ui-task-board TaskBoardSettingsCard',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-pet DeepSeekPet as never id \'deepseek-pet\'',
    ],
    replaceRisk: 'none',
